...
export class GMGPlatformAccessory {
  ...
  private mainPowerService: Service | undefined
  private grillThermostatService: Service | undefined
  private foodTemperatureService: Service | undefined
  private pelletAlarmService: Service | undefined
  private fanService: Service | undefined
  private currentCookingTemperatureCharacteristic: Characteristic | undefined
  private targetCookingTemperatureCharacteristic: Characteristic | undefined
  private currentFoodTemperatureCharacteristic: Characteristic | undefined
  private targetFoodTemperatureCharacteristic: Characteristic | undefined
    ...
    this.platform.smokerService!.getStatus()
      .then(status => {
        if (status) {
          ...
          this.pelletAlarmService!.updateCharacteristic(this.platform.Characteristic.SmokeDetected,
            this.getPelletAlarmIsActive())
          ...
          this.foodTemperatureService!.updateCharacteristic(this.platform.Characteristic.TargetHeatingCoolingState,
            this.getFoodProbeState())
          this.foodTemperatureService!.updateCharacteristic(this.currentFoodTemperatureCharacteristic!.displayName,
            this.getCurrentFoodTemp())
          this.foodTemperatureService!.updateCharacteristic(this.targetFoodTemperatureCharacteristic!.displayName,
            this.getTargetFoodTemp())
        }
      })
